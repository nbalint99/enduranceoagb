...
class NewStintFragment : DialogFragment() {
    interface NewStintListener {
        fun onStintCreated(teamName: String, teamNumber: Int, driver: String, driverWeight: Double?, totalWeight: Double?, stintNumber: Int, shortTeamName: String?, weight: Double, info: String? = null, kartNumber: Int, expectedKartNumber: Int, driverName: String?, plusWeightDriver: String?, stintDonePrev: String, stintIdpass: String? = null, raceIdpass: String? = null)
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val dataPassedUnder10: String? = arguments?.getString("under10")
        ...
        dbRef.get().addOnCompleteListener { p0 ->
            if (p0.isSuccessful) {
                ...
                if (dataPassedStint.toString().toInt() == 1) {
                    ...
                    else if (dataPassedTeamId.toString().toInt() == dataPassedSecondGroup.toString().toInt() && dataPassedUnder10 == "false") {
                        val stintTeam = (dataPassedStint.toString().toInt()-1).toString() + "-" + "box12"
                        val kartNum = p0.result.child("Stints").child(change).child("Info").child(stintTeam).child("kartNumber").value.toString()
                        binding.etKartNumberStint.setText(kartNum)
                    }
                    else if (dataPassedTeamId.toString().toInt() == dataPassedSecondGroup.toString().toInt() && dataPassedUnder10 == "true") {
                            ...
                            dialogBuilder.setPositiveButton(R.string.button_ok) { _, _ ->
                                if (specialWeight.text.toString()
                                    ...
                                    listener.onStintCreated(
                                        ...
                                        selectedDriver,
                                        dataPassedDriverWeight.toString().toDoubleOrNull(),
                                        dataPassedTotalWeight.toString().toDoubleOrNull(),
    ...
    companion object {
        ...
        fun newInstance(
            ...
            args.putString("under10", under10)
